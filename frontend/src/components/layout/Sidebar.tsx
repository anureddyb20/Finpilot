  ...
  return (
    <div className="flex flex-col w-64 bg-white border-r border-slate-100 h-screen fixed left-0 top-0">
      ...
      <div className="p-4 border-t border-slate-100 space-y-1">
        ...
        <button className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-600 hover:bg-red-50 hover:text-red-600 transition-colors w-full">
